...
exports.verificationSent =
  "Verification email sent.Verify your email and get 3 free invoice vouchers";
...
exports.walletCreateSuccess = "Wallet created successfully";
exports.fetchWalletSuccess = "Wallet retrieve successfully";
exports.walletFundSuccess = "Funds added to wallet successfully";
exports.fetchPlanSuccess = "Plans retrieved from database successfully";
exports.planCreateSuccess = "Plan created successfully";
...
exports.addWalletToDbError = "Error creating new wallet";
exports.fetchWalletError = "Error fetching wallet";
exports.deleteWalletError = "Failed to delete wallet";
exports.updateWalletError = "updating wallet info failed";
exports.walletNotFoundError = "Wallet not found";
exports.fetchPlanError = "Error fetching plan";
exports.planNotFoundError = "Invoice plan not found";
exports.addPlanToDbError = "Error creating new plan";
exports.noPlansFound = "No Plans found";
exports.jwtExpiredError = "Token expired. Please login again";
